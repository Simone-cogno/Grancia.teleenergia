    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <fieldset>
                ...
                <form class="form-horizontal;border-right-style: 200;" role="form" action="verifica.php">
                ...
                if($code=='')
                    return;
                if(checkCode($code)){
                    echo "codice valido. Redirezione al download...";
                    header( "url=Gestitank_Mobile.apk" );
                }
                else{
